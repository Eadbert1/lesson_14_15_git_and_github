...
app.get("/finance", async (req,res) =>{
    const sql = "SELECT SUM(CASE WHEN transaction_type = 'income' THEN money ELSE 0 END) as total_income, SUM(CASE WHEN transaction_type = 'outcome' THEN money ELSE 0 END) AS total_outcome FROM finance"
...
app.post("/finance/store", async(req,res) =>{
    try{
        ...
        const sql = "INSERT INTO finance (transaction_name, money, transaction_type) VALUES(?,?,?) "
